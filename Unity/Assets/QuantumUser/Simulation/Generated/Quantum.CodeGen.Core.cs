...
namespace Quantum {
  ...
  public enum GrowableID : int {
    GreenBean = 0,
  }
  public enum GrowableStage : int {
    Seed = 0,
    Emerging = 1,
    Seedling = 2,
    Established = 3,
  ...
  public unsafe partial struct _globals_ {
    ...
    public readonly FixedArray<Input> input {
      get {
        fixed (byte* p = _input_) { return new FixedArray<Input>(p, 72, 16); }
      }
    }
    public override readonly Int32 GetHashCode() {
      unchecked { 
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct QGrowable : Quantum.IComponent {
    public const Int32 SIZE = 12;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    public GrowableID ID;
    [FieldOffset(8)]
    public Int32 Age;
    [FieldOffset(4)]
    public GrowableStage Stage;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 13633;
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->Age);
    }
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.QGrowable>();
      BuildSignalsArrayOnComponentRemoved<Quantum.QGrowable>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.GrowableID), 4);
      typeRegistry.Register(typeof(Quantum.GrowableStage), 4);
      ...
      typeRegistry.Register(typeof(Quantum.QGrowable), Quantum.QGrowable.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 10)
        ...
        .Add<Quantum.QGrowable>(Quantum.QGrowable.Serialize, null, null, ComponentFlags.None)
        .Finish();
    }
    [Preserve()]
    public static void EnsureNotStrippedGen() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.GrowableID>();
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.GrowableStage>();
