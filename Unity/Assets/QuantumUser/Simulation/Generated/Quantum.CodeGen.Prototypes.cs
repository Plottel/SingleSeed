...
namespace Quantum.Prototypes {
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.QGrowable))]
  public unsafe partial class QGrowablePrototype : ComponentPrototype<Quantum.QGrowable> {
    public Quantum.QEnum32<GrowableID> ID;
    public Int32 Age;
    public Quantum.QEnum32<GrowableStage> Stage;
    partial void MaterializeUser(Frame frame, ref Quantum.QGrowable result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.QGrowable component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.QGrowable result, in PrototypeMaterializationContext context = default) {
        result.ID = this.ID;
        result.Age = this.Age;
